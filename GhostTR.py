#!/usr/bin/python
# << CODE BY NORRIS
# << Personal tool for OSINT and Information Gathering
# << Tailored and customized for private use.
# << NORRY_GHOSTY v2.2 Custom Suite
...
def IP_Track():
    ...
    print()
    print(f' {Wh}============= {Gr}NORRY_GHOSTY IP TRACKER {Wh}=============')
...
def phoneGW():
    ...
    print(f"\n {Wh}========== {Gr}NORRY_GHOSTY PHONE TRACKER {Wh}==========")
...
def TrackLu():
    ...
    print(f"\n {Wh}========== {Gr}NORRY_GHOSTY USERNAME TRACKER {Wh}==========")
    print()
...
def option():
    ...
    clear()
    stderr.writelines(f"""
     _   ______  ____  ______  __   ________  ______  ____________  __
    / | / / __ \/ __ \/ __ \ \/ /  / ____/ / / / __ \/ ___/_  __/\ \/ /
   /  |/ / / / / /_/ / /_/ /\  /  / / __/ /_/ / / / /\__ \ / /    \  / 
  / /|  / /_/ / _, _/ _, _/ / /  / /_/ / __  / /_/ /___/ // /     / /  
 /_/ |_/\____/_/ |_/_/ |_| /_/   \____/_/ /_/\____//____//_/     /_/   

              {Wh}[ + ]  C O D E   B Y  N O R R I S  [ + ]
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}    NORRY_GHOSTY TRACKER     {Wh}|
       : o    `.        {Wh}|       {Gr}@CODE BY NORRIS        {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
